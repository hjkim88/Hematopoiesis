...
#                                   aggr_feature_bc_mat_dir="Z:/ResearchHome/SharedResources/Immunoinformatics/hkim8/Wenjun/Result/Wenjun_aggr/outs/count/filtered_feature_bc_matrix/",
...
wenjun_preprocess <- function(cellranger_result_dir="Z:/ResearchHome/SharedResources/Immunoinformatics/hkim8/Wenjun/Result/",
  ...
  g <- arrangeGrob(grobs = p,
                   nrow = 3,
                   ncol = 2)
  ggsave(file = paste0("./data/Wenjun_Data_QC_Results.pdf"), g, width = 25, height = 18)
  ...
  ### remove TDH026_1350503, TDH026_135592, TDH027_1350504, TDH027_1355924
  ...
  Wenjun_Seurat_Obj$Cell1[which(Wenjun_Seurat_Obj$library %in% c("TDH017", "TDH018_2", "Wenjun_Heme2_2", "Wenjun_Heme1_2"))] <- "Heme"
  Wenjun_Seurat_Obj$Cell1[which(Wenjun_Seurat_Obj$library %in% c("TDH019_2", "TDH025_2", "Wenjun_Stromal2_2", "Wenjun_Stromal1_2"))] <- "Stroma"
  ...
  ### Filter cells that have unique feature counts over 7000 or less than 300
  ### Filter cells that have RNA mocule # > 50000
  ### Filter cells that have > 10% mitochondrial counts
  Wenjun_Seurat_Obj <- subset(Wenjun_Seurat_Obj, subset = nFeature_RNA > 300 & nFeature_RNA < 7000 & nCount_RNA < 50000 & percent.mt < 10)
  ...
  Wenjun_Seurat_Obj$Development <- factor(Wenjun_Seurat_Obj$Development, levels = c("P6", "P14", "P21", "P28"))
  Wenjun_Seurat_Obj$Cell2 <- factor(Wenjun_Seurat_Obj$Cell2,
                                    levels = c("P6_Heme", "P6_Stroma", "P14_Heme", "P14_Stroma", "P21_Heme", "P21_Stroma", "P28_Heme", "P28_Stroma"))
